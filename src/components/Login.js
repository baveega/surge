    ...
    return (
        <div className="myform">
            ...
            <form onSubmit={submitForm}>
                ...
                <input type="email" name="email" onChange={onChangeInput} placeholder="Username/ Email" id="email" value={formData.email} required />
                ...
                <div className="bottom-link"><Link to="/signup">Register</Link></div>
            </form>
        </div>
    )
}
